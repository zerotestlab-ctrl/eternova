    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a personal memory assistant. Answer questions based ONLY on the provided memory context.
Be concise, specific, and cite relevant facts from the context. If the context doesn't contain relevant information, say so.
